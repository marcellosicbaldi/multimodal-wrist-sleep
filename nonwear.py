# Description: This script contains the non-wear algorithm used in the paper "A Novel Approach to Detecting Non-Wear Time in Free-Living Accelerometer Data in Adults" by Adam Vert, et al.

# Original Implementation by Adam Vert and Kit Beyer at https://github.com/nimbal/nimbaldetach
